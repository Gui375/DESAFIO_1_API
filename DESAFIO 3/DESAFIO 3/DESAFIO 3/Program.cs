...
Console.WriteLine("|   2. Procurar por moeda e data                    | ");
...
try
{
    switch (menu)
    {
        case 1:
            ...
            Console.WriteLine("|   Moeda que vai ser comparada com o real:         | ");
            Console.WriteLine("|   Moeda gringa:                                   | ");
            Console.WriteLine("|   Selecione uma opção:                            | ");
            ...
            dados.moeda2 = "brl";
            Console.WriteLine();
            if (dados.moeda1 == "dollar")
            {
                dados.moeda1 = "usd";
            }
            else if (dados.moeda1 == "euro")
            {
                dados.moeda1 = "eur";
            }
            else if (dados.moeda1 == "bitcoin")
            {
                dados.moeda1 = "bct";
            }
            else
            ...
            using (HttpClient client = new HttpClient())
            {
                try
                {
                    ...
                    if (dados.moeda1 == "usd" && dados.moeda2 == "brl")
                    {
                    ...
                    else if (dados.moeda1 == "eur" && dados.moeda2 == "brl")
                    {
                    ...
                    else if (dados.moeda1 == "btc" && dados.moeda2 == "brl")
                    {
        ...
        //    dados.moeda2 = "brl";
        //    Console.WriteLine("Digite a quantidade de retornos ");
        ...
        case 2:
            ...
            Console.WriteLine("Segunda sera o real");
            dados.moeda2 = "brl";
            Console.WriteLine("Digite a data inicial, exemplo: 20230101");
            dados.startDate = Console.ReadLine();
            Console.WriteLine("Digite a data final, exemplo: 20230131");
            Console.WriteLine();
...
{
    //tentei fazer uma tratagem de erro mas nao deu kkkk
    Thread.Sleep( 1000 );   
